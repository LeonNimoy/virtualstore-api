...
var ensureDataValidation_1 = __importDefault(require("../../middlewares/ensureDataValidation"));
var usersRouter = express_1.Router();
var userController = new UsersController_1.default();
usersRouter.get('/:id?', userController.list);
usersRouter.post('/', ensureDataValidation_1.default, userController.create);
